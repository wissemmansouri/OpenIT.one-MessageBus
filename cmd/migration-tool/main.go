...
const (
	messageBusConfigDirPath  = "/etc/openit"
	messageBusConfigFilePath = "/etc/openit/message-bus.conf"
	messageBusName           = "openit-message-bus.service"
	messageBusNameShort      = "message-bus"
)

//go:embedded ../../build/sysroot/etc/openit/message-bus.conf.sample
