...
import (
	...
	"github.com/wissemmansouri/OpenIT.one-Common/utils/file"
	...
	"github.com/wissemmansouri/OpenIT.one-MessageBus/common"
	"github.com/wissemmansouri/OpenIT.one-MessageBus/config"
	"github.com/wissemmansouri/OpenIT.one-MessageBus/repository"
	"github.com/wissemmansouri/OpenIT.one-MessageBus/route"
...
var (
	...
	//go:embed build/sysroot/etc/openit/message-bus.conf.sample
	_confSample string
)
