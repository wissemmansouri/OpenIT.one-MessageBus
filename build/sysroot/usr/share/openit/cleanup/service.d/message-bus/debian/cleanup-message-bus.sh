...
readonly OPEN_SERVICES=(
    "openit-message-bus.service"
)

readonly OPEN_EXEC=openit-message-bus
readonly OPEN_CONF=/etc/openit/message-bus.conf
readonly OPEN_DB=/var/lib/openit/db/message-bus.db
